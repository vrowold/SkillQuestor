...
class InfoViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.title = "Skill Information"
        descTitle.text = selectedSkill.name.capitalizedString
        skillDesc.text = selectedSkill.descript
        skillImage.image = UIImage( named:selectedSkill.name + "_icon")
